...
/// 4. استخدمها فقط
// #theorem[مبرهنة إقليدس][
//   هناك عدد لا نهائي من الأعداد الأولية.
// ] <thm:euclid>
// #theorem-box[مبرهنة بدون ترقيم][
...
/// 7. تحديد رقم أو مكمل
// #theorem(title: "مبرهنة إقليدس", number: "233", supplement: [مبرهنة])[
//   هناك عدد لا نهائي من الأعداد الأولية.
// ]

/// 8. استمرار العداد: استخدم مصفوفة أرقام لمتابعة الترقيم من قيمة محددة
// #theorem(number: (2, 3))[
//   هذه المبرهنة مرقمة صراحة 2.3.
//   يستمر العداد من هنا، لذا المبرهنة التالية المرقمة تلقائيًا هي 2.4.
// ]

/// 9. مراجع مرنة: مرجع بدون عنوان باستخدام @label[-]؛ أو مرجع مع عنوان ورقم باستخدام @label[!!]
// مرجع بدون عنوان: @thm:euclid[-]؛ أو مرجع مع عنوان ورقم: @thm:euclid[!!]

/// 10. عنوان كامل مخصص: تجاوز تنسيق "البادئة الرقم (العنوان)" المُنشأ تلقائيًا
// #theorem(full-title: [المبرهنة الأساسية])[
//   هناك نتيجة أساسية.
// ]
...
#theorem-box(outlined: false)[مبرهنة بدون ترقيم][
  هذه المبرهنة ليست مرقمة.
]
```
...
#conjecture[حدسية الأعداد الأولية التوأم][
...
#postulate[المبرهنة الأساسية في الجبر][
